...
public class InputParser {
    ...
    private ShoppingChart BuildShoppingChart(String[] barCodes, HashMap<String, Item> itemIndexes) {
        ...
        for (String barcode : barCodes) {
            ...
            else if(mappedItem.getIsPromotion()){
            	 item = new Item(barcode, mappedItem.getName(), mappedItem.getUnit(), mappedItem.getPrice(),mappedItem.getDiscount(),mappedItem.getvipDiscount(),true);
            }
